    ...
    <div class="container mt-4">
        ...
        <form action="alta_cliente.php" method="POST"><!--El formulario pone los datos que hemos puesto aqui a alta_cliente.php-->
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="edad" name="edad" oninput="pack()" required>
            </div>
            ...
            <!--Este campo se muestra solo si el cliente a selecionado que coge el plan estandar o premium-->
            <div class="form-floating" id="segundo_pack" style="display: none">
            ...
            <br>
            <div class="form-floating">
                <select class="form-select" id="duracion" name="duracion" required><!--El cliente pone durante cuanto quiere pagar, por mes o la año-->
